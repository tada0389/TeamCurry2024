...
public static class BGMPath{
	...
	public const string WAYIN_MUSIC   = "BGM/Way-in_music";
	public const string WAYIN_MUSIC_2 = "BGM/Way-in_music_2";
	public const string WAYOUT_MUSIC  = "BGM/Way-out_music";
